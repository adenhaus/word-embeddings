...
const About = () => {
  return (
    <Box sx={{ px: { xs: '15px', md: '50px', lg: '50px' } }}>
      ...
      <Typography level='body-md' sx={{ mb: 1 }}>
        You can use the <Link href='https://github.com/piskvorky/gensim' target='_blank'>Gensim</Link> Python library to manipulate pretrained word embeddings. This <Link href='https://www.ibm.com/topics/word-embeddings' target='_blank'>article by IBM</Link>, <Link href='https://www.youtube.com/watch?v=5MaWmXwxFNQ&ab_channel=AssemblyAI' target='_blank'>YouTube video by AssemblyAI</Link> (which also shows how to use Gensim), <Link href='https://informatics.ed.ac.uk/news-events/news/news-archive/king-man-woman-queen-the-hidden-algebraic-struct' target='_blank'>paper summary by The University of Edinburgh</Link> and, for those with shorter attention spans, <Link href='https://www.youtube.com/shorts/FJtFZwbvkI4' target='_blank'>YouTube short by 3blue1brown</Link> are all great if you want to learn more.
      </Typography>
      <Typography level='title-lg' sx={{ mb: 1, mt: 3 }}>
        LLMs
      </Typography>
